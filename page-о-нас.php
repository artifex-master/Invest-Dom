            ...
            <div class="philosophy__grid-philosophy grid-philosophy">
              <div class="grid-philosophy__item philosophy-card">
                <div class="philosophy-card__inner">
                  ...
                  <div class="philosophy-card__icon">
                    <img src="<?php echo get_theme_file_uri('/assets/images/philosophy-card-1.svg'); ?>"
              ...
              <div class="grid-philosophy__item philosophy-card">
                <div class="philosophy-card__inner">
                  ...
                  <div class="philosophy-card__icon">
                    <img src="<?php echo get_theme_file_uri('/assets/images/philosophy-card-2.svg'); ?>"
              ...
              <div class="grid-philosophy__item philosophy-card">
                <div class="philosophy-card__inner">
                  ...
                  <div class="philosophy-card__icon">
                    <img src="<?php echo get_theme_file_uri('/assets/images/philosophy-card-3.svg'); ?>"
              ...
              <div class="grid-philosophy__item philosophy-card">
                <div class="philosophy-card__inner">
                  ...
                  <div class="philosophy-card__icon">
                    <img src="<?php echo get_theme_file_uri('/assets/images/philosophy-card-4.svg'); ?>"
        ...
        <div class="mfca__outer">
          <div class="mfca__inner">
            ...
            <div class="mfca__subtitle">
              <p>Филиал в МФЦА, согласно признанным лицензиям Компании, качественно оказывает своим клиентам следующий
                перечень услуг:</p>
            </div>
            ...
            <div class="news-grid-wrapper">
              <div class="news__grid-news grid-news">
                <div class="grid-news__main">
                  <img class="news-main-img" width="100%"
                    src="<?php echo get_theme_file_uri('/assets/images/gied-news-img-main.png'); ?>"
                  ...
                  <div class="grid-news__news-watcher news-watcher">
                    ...
                    <div class="news-watcher__eye-icon eye-icon">
                      <img src="<?php echo get_theme_file_uri('/assets/images/icons/eye-icon.svg'); ?>"
                        alt="./assets/images/icons/eye-icon.svg" />
                    </div>
                  </div>
                ...
                <div class="grid-news__col">
                  <div class="grid-news__col-row">
                    <div class="grid-news__item">
                      <img width="100%"
                        src="<?php echo get_theme_file_uri('/assets/images/news-grid__item-img-1.png'); ?>"
                        alt="./assets/images/news-grid__item-img-1.png" />
                    ...
                    <div class="grid-news__item">
                      <img width="100%"
                        src="<?php echo get_theme_file_uri('/assets/images/news-grid__item-img-2.png'); ?>"
                        alt="./assets/images/news-grid__item-img-2.png" />
                      <div class="news-grid-item__news-title news-title">
                        <p>Уведомление об утверждении новой редакции типовой формы договора для физических лиц</p>
                      </div>
                      <div class="grid-news-item__news-watcher news-watcher">
                  ...
                  <div class="grid-news__col-row">
                    <div class="grid-news__item">
                      <img width="100%" height="100%"
                        src="<?php echo get_theme_file_uri('/assets/images/news-grid__item-img-3.png'); ?>"
                        alt="./assets/images/news-grid__item-img-3.png" />
                      <div class="news-grid-item__news-title news-title">
                        <p>Уведомление об утверждении новой редакции типовой формы договора для физических лиц</p>
                      </div>
                      <div class="grid-news-item__news-watcher news-watcher">
              ...
              <ul class="slider__slider-list slider-list">
                <li class="slider-list__item">
                  <figure class="slider-item__img">
                    <img width="100%" src="<?php echo get_theme_file_uri('/assets/images/main-slider-img-1.png'); ?>"
                      alt="./assets/images/main-slider-img-1.png" />
                  </figure>
                ...
                <li class="slider-list__item">
                  <figure class="slider-item__img">
                    <img width="100%" src="<?php echo get_theme_file_uri('/assets/images/main-slider-img-3.png'); ?>"
                      alt="./assets/images/main-slider-img-3.png" />
                  </figure>
                  <div class="slider-item__inner">
                    <div class="slider-item__date">
